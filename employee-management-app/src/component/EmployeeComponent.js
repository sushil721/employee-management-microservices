            ...
            <div> <br/><br/>
                <div className='card col-md-6 offset-md-3'>
                    ...
                    <div className='card-body'>
                        ...
                        <div className='row'>
                            <p><strong>Employee Department : </strong> {this.state.employee.departmentCode}</p>
                        </div>
                        <div className='row'>
                            <p><strong>Employee Organization : </strong> {this.state.employee.organizationCode}</p>
                        </div>
                    </div>
                    ...
                    <div className='card-body'>
                        ...
                        <div className='row'>
                            <p><strong>Organization Address : </strong> {this.state.organization.organizationAddress}</p>
                        </div>
                        <div className='row'>
                            <p><strong>Organization Created Date : </strong> {this.state.organization.createdDate}</p>
                        </div>
                    </div>
