...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(value = DepartmentCodeAlreadyExistException.class)
    public ResponseEntity<ErrorDetails> handleEmailAlreadyExistException(DepartmentCodeAlreadyExistException ex, WebRequest webRequest) {
        ErrorDetails errorDetails =
                new ErrorDetails(
                        LocalDateTime.now(),
                        ex.getMessage(),
                        webRequest.getDescription(false),
                        "DEPARMENT_ID_ALREADY_EXISTS");
